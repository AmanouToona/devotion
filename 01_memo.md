...
カードがN枚ある。　3枚選び最大と最小を削除する。　操作を繰り返し重複を無くしたとき、最大で何枚のカードを残せるか？

* AC
* 実は常に最善手の重複を2減らすができるのでは？　-> できる

## ABC216_E
数列A(N)　が与えられる。 1度選択すると -1　される。 K回の選択の合計値の最大はいくつか？
* AC
* 貪欲法を高速に行った。 2分探索かもしれないと思ったが、考察しきれなかった。
* 最終スコアの2分探索を考えていた。　最終状態の数列の要素の最大値という1クッション置いた値を求める2部探索に思い至らなかった。

## ARC017_B
数列A が与えられる Aの中に長さK以上の単調増加になっている位置は何か所あるか？
* AC  2WA
* 尺取り法で行ける。　尺取り法の書き方下手でバグらせた。

## ABC194_E
長さNの数列Aの連続する区間M の全てのうちで mexの最小値を求めよ
* WA
* 尺取り的にやろうとしたが処理できない。　セグ木で行けるとも思ったが mex 計算を落としこめなかった。 2分探索も考えた。
* 実は尺取り的にできる。　追加・削除する数字しか変わらないことに注意すると…　発想はDAGに近いものを感じた。 DAG系の問題が解けないことがあったのでこの発想が苦手らしい。
...
* AC
* とりあえずやったが、正当性がわからなかった。　端が0であることが保証されているから求まる？
